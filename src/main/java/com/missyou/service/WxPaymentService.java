...
public class WxPaymentService {
    ...
    private Map<String, String> makePaySignature(Map<String, String> wxOrder) {
        ...
        wxPayMap.put("appId", WxPaymentService.lWxPayConfig.getAppID());
        ...
        String sign;
        try {
            sign = WXPayUtil.generateSignature(wxPayMap, WxPaymentService.lWxPayConfig.getKey(), WXPayConstants.SignType.HMACSHA256);
        } catch (Exception e) {
            e.printStackTrace();
            throw new ServerErrorException(9999);
        }
    ...
    public WXPay assembleWxPayConfig() {
        WXPay wxPay;
        try {
            wxPay = new WXPay(WxPaymentService.lWxPayConfig);
        } catch (Exception ex) {
            throw new ServerErrorException(9999);
        }
        return wxPay;
